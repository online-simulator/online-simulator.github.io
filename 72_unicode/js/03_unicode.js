...
My_test_unicode.prototype.clear = function(){
  ...
  My$_id("textarea-output_utf16").value = "";
  My$_id("textarea-output_utf8").value = "";
  return self;
};
My_test_unicode.prototype.str2code = function(){
  ...
  My$_id("textarea-output_utf16").value = output_utf16;
  try{
...
My_test_unicode.prototype.postset_utf16 = function(){
  var self = this;
  My$_id("textarea-input").value = My$_id("textarea-output_utf16").value;
  return self;
};
