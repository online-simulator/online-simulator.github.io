...
My_entry.handler_wave.prototype.composite_buffer_soundData_LE = function(data){  // Ver.1.103.22  // Ver.1.105.22  // Ver.1.108.23
  ...
  /* Ver.1.48.11 -> */
  var newSetter = self.waveo.handler_baseview.make_setget("set"+Prop, Bytes_perSample, newView);  // Ver.1.110.24
  var newGetter = self.waveo.handler_baseview.make_setget("get"+Prop, Bytes_perSample, newView);  // Ver.1.110.24
  /* -> Ver.1.48.11 */
  ...
  buffers.forEach(function(buffer, j){
    ...
    var outGetter = self.waveo.handler_baseview.make_setget("get"+Prop, Bytes_perSample, outView);  // Ver.1.48.11  // Ver.1.110.24
    /* Ver.1.18.4 -> */
    var ns = buffer.ns;
    var ne = buffer.ne;
