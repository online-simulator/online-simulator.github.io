...
My_entry.solver_real = function(){
  var self = this;
  self.init.apply(self, arguments);
  return self;
};

My_entry.solver_real.prototype.init = function(){
  var self = this;
  new My_entry.original_main().setup_constructors.call(self);
  new My_entry.original_main().make_instances.call(self, ["math"]);
  return self;
};
My_entry.solver_real.prototype.gaussian = function(options, obj_Axb){
  var self = this;
...
My_entry.solver_real.prototype.gaussian_pre = function(options, obj_Axb){
  var self = this;
...
My_entry.solver_real.prototype.gaussian_forward = function(options, obj_Axb){
  var self = this;
  var N = obj_Axb.N;
  var A = obj_Axb.A;
  var b = obj_Axb.b;
...
My_entry.solver_real.prototype.gaussian_backward = function(options, obj_Axb){
  var self = this;
  var N = obj_Axb.N;
  var A = obj_Axb.A;
  var x = obj_Axb.x;
...
My_entry.solver_real.prototype.gaussian_coo = function(options, obj_Axb){
  var self = this;
...
My_entry.solver_real.prototype.gaussian_coo_init = function(options, obj_Axb){
  var self = this;
  var aA = obj_Axb.aA;
  var mA = obj_Axb.mA;
  var nA = obj_Axb.nA;
...
My_entry.solver_real.prototype.get_jn = function(arr_n, n0, opt_isChecked){
  var self = this;
  var _jn = -1;
...
My_entry.solver_real.prototype.gaussian_coo_pre = function(options, obj_Axb){
  var self = this;
  var math = self.entry.math;
  var N = obj_Axb.N;
...
My_entry.solver_real.prototype.gaussian_coo_forward = function(options, obj_Axb){
  var self = this;
  var N = obj_Axb.N;
  var m2arr_n = obj_Axb.m2arr_n;
  var m2A = obj_Axb.m2A;
...
My_entry.solver_real.prototype.gaussian_coo_backward = function(options, obj_Axb){
  var self = this;
  var N = obj_Axb.N;
  var m2arr_n = obj_Axb.m2arr_n;
  var m2A = obj_Axb.m2A;
