...
//    var dyi= 1/Nj;
    ...
    /* -> 1.50.8 */
    _obj = {u: u, v: v, ud: ud, vd: vd, p: p, p0: p0, id: id, hasP0: hasP0, i_unknowns: i_unknowns, j_unknowns: j_unknowns, Ni: Ni, Nj: Nj, len0: i_unknowns.length, dx: dxi, dy: dyi, t: 0, cmax: 0, Lx: Lx, Ly: Ly};  // fluid-Ver.1.10.0  // fluid-Ver.1.11.0
  }
  return _obj;
};
/* 1.31.8 */
