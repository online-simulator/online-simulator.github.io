...
My_handler_dom.prototype.__drag__ = {};
My_handler_dom.prototype.__drag__.init = function(id_drag, id_checkbox, opt_handler){
  var self = this;
...
My_handler_dom.prototype.__drag__.switch = function(opt_handler){
  var self = this;
