...
/* wave-Ver.1.110.24 */
My_entry.handler_baseview.prototype.make_setget = function(setgetProp, view, n){
  var self = this;
  var isSet = setgetProp.match("set");
  var isUnsigned = setgetProp.match("Uint");
  var methodName = ((isSet)? "set": "get")+((isUnsigned)? "Uint8n": "Int8n");
  var method = (isSet)? 
    function(offset, val, isLE){return self[methodName](view, n, offset, val, isLE);}:
    function(offset, isLE)     {return self[methodName](view, n, offset, isLE);};
  return (view[setgetProp])? function(){return view[setgetProp].apply(view, arguments);}: method;
};
My_entry.handler_baseview.prototype.make_view = function(Prop, n){
  ...
  self.set[n] = self.make_setget("set"+Prop, view, n);
  self.get[n] = self.make_setget("get"+Prop, view, n);
  return self;
};
/*
                  int8       uint8
