...
0x8000~ffff: -32768~-1 32768~65535
  ...
  self.setInt8n(view, n, i0, val_in, isLE);
  var val_out = self.getInt8n(view, n, i0, isLE);

  var n = 3;
  var i0 = 0;
  var isLE = true;
  var val_in = 8388608*2-1;
  var view = self.arr_view[n];
  self.setUint8n(view, n, i0, val_in, isLE);
  var val_out = self.getUint8n(view, n, i0, isLE);
*/
My_entry.handler_baseview.prototype.setInt8n = function(view, nByte, i0, val10, isLE){
  var self = this;
  ...
  for(var i=0; i<nByte; ++i){
    ...
    view.setInt8(i0+((isLE)? i: nByte-1-i), val10i);  // -128~127
  }
  return self;
};
My_entry.handler_baseview.prototype.setUint8n = function(view, nByte, i0, val10, isLE){
  var self = this;
  var offset = 0;
  var val16 = parseInt(val10+offset).toString(16);  // val16 >= 0
  var len16 = val16.length;
  for(var i=0; i<nByte; ++i){
    ...
    var val16i = val16.substring(ie-2, ie) || "0";
    var val10i = Number("0x"+val16i);  // 0~255
    view.setUint8(i0+((isLE)? i: nByte-1-i), val10i);  // 0~255
  }
  return self;
};
My_entry.handler_baseview.prototype.getInt8n = function(view, nByte, i0, isLE){
  var self = this;
  var offset = self.offset[nByte];
  var val16 = "";
  for(var i=0; i<nByte; ++i){
    var val10i = view.getUint8(i0+((isLE)? i: nByte-1-i));
...
My_entry.handler_baseview.prototype.getUint8n = function(view, nByte, i0, isLE){
  var self = this;
  var offset = 0;
  var val16 = "";
  for(var i=0; i<nByte; ++i){
